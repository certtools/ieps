...
The IEPs should be discussed on the [intelmq-dev Mailinglist](https://lists.cert.at/mailman3/hyperkitty/list/intelmq-dev@lists.cert.at/).
...
| 008 | [IntelMQ Data Format: Constituency field](008/)                        | [Implementation completed](https://github.com/certtools/intelmq/pull/2573)                 | 3.5.0          |
| 009 | [IntelMQ Data Format: Describe product and mark vulnerabilities](009/) | [Implementation completed](https://github.com/certtools/intelmq/pull/2574)                 | 3.5.0          |
...
* Discussion in progress: The Community has not yet decided
* Implementation waiting: IEP was approved by the community, and the implementation is waiting
* Implementation in progress: IEP was approved by the community, and the implementation is in progress
* Implementation completed: IEP was approved by the community, and the implementation is completed
